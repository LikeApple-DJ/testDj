...
public class ExportServiceImpl implements ExportService {
    ...
    public byte[] exportHelloWorld() {
        Object cached = demoService.getCachedResult("helloworld");
        if (cached == null) {
    ...
    public byte[] exportHash() {
        Object cached = demoService.getCachedResult("hash");
        if (cached == null) {
    ...
    public byte[] exportBubbleSort() {
        Object cached = demoService.getCachedResult("bubble-sort");
        if (cached == null) {
